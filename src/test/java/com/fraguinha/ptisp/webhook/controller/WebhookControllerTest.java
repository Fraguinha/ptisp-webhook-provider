...
class WebhookControllerTest {
    ...
    @Test
    void negotiationAdvertisesManagedDomainsAsDomainFilter() throws Exception {
        Mockito.when(this.dnsService.getManagedDomains()).thenReturn(List.of("a50passos.com", "livinvicta.pt"));
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.include[0]").value("a50passos.com"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.include[1]").value("livinvicta.pt"));
    }

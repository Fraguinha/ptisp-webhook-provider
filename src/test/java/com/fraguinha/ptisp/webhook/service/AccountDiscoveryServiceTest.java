...
class AccountDiscoveryServiceTest {
    ...
    @Test
    void returnsEmptyListForEmptyEnv() {
        final List<ManagedAccount> accounts = this.discoveryService.discoverAccounts(Map.of(), RestClient.builder());

        Assertions.assertTrue(accounts.isEmpty());
    }

    @Test
    void ignoresUnrelatedEnvKeys() {
        final Map<String, String> env = Map.of(
                "HOME", "/home/user",
                "PATH", "/usr/bin",

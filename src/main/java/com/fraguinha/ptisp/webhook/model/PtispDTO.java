...
public record PtispDTO(
    ...
    public record ListResponse(
        ...
        public ListResponse(final String result, final List<PtispDTO> records) {
            this(result, "", records);
        }
        ...
        public String describe() {
            return this.message == null || this.message.isBlank() ? String.valueOf(this.result) : this.message;
        }
    }
    ...
    public static PtispDTO fromExternalDns(final ExternalDnsDTO endpoint, final String target) {
        ...
        final long ttl = (endpoint.ttl() == null || endpoint.ttl() == 0L) ? WebhookConstants.DEFAULT_TTL : endpoint.ttl();
